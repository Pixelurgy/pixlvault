          ...
          <div class="toolbar-sort-panel">
            ...
            >
              ...
              <v-btn-toggle
                ...
                class="toolbar-similarity-toggle"
            ...
            >
              ...
              <div class="toolbar-sort-select-wrapper" style="flex: 1 1 0">
                <select
...
.toolbar-sort-select {
  ...
  border: 0px solid rgba(var(--v-theme-border), 0.5);
  min-height: var(--toolbar-control-height);
